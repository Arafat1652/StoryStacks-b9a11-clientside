...
const Footer = () => {
	...
	<section className="pt-16 pb-7 px-4 divide-y bg-base-200 ">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 min-[1130px]:grid-cols-12 gap-8 lg:gap-0 pb-14 border-b-2 border-gray-200">
        <div className="min-[1130px]:col-span-5 col-span-1 w-full min-[1130px]:max-w-full mx-auto">
          ...
          <span className='text-2xl font-ant'>StoryStacks</span>
        </Link>
           <div className="flex flex-col min-[470px]:flex-row items-center gap-3 w-full">
            <div className="relative  text-gray-500 focus-within:text-gray-900 max-sm:w-full">
              ...
              <input type="text" id="default-search"
                ...
                placeholder="mail@storystack.com"/>
            </div>
            <a href="/"
              className="py-3 px-7 rounded-lg  max-[470px]:w-full text-base font-semibold transition-all duration-500 bg-[#000000] text-[#ccff00]">Subscribe</a>
           </div>
        ...
        <div className="min-[1130px]:col-span-7 max-[1130px]:pt-10 lg:pl-14 col-span-1 w-full min-[1130px]:max-w-full mx-auto flex flex-col sm:flex-row justify-between gap-6 ">
          <div className="">
            ...
            <ul className="flex flex-col gap-6">
              <li><p href="javascript:;"
                  className="text-base font-normal max-sm:text-center  text-gray-600">61-A, Elm street, Dhaka, Bangladesh.</p>
              </li>
          ...
          <div className="">
            ...
            <ul className="flex flex-col gap-6">
              ...
              <li><p href="javascript:;"
                  className="text-base font-normal max-sm:text-center text-gray-600 whitespace-nowrap ">support@storystack.com</p></li>
      ...
      <div className="flex flex-col-reverse gap-5 md:flex-row items-center first-letter:items-center justify-between pt-7">
        <p className="font-normal text-sm text-gray-400">©<a href="https://pagedone.io/">StoryStacks</a>2023, All rights reserved.</p>
          ...
          <button
            ...
            <svg
              ...
              <path
                ...
                fill=""></path>
              <path className="fill-white group-hover:fill-sky-500 group-focus-within:fill-sky-500" fillRule="evenodd" clipRule="evenodd"
